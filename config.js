...
export const training = [
  ...
  {
    workout: "Групповые тренировки по боксу",
    items: [
      { name: "Дети (5+) 10 тренировок (1 месяц)", price: 4000 },
      { name: "Дети (8+) 10 тренировок (1 месяц)", price: 4000 },
      { name: "Дети (14+) 10 тренировок (1 месяц)", price: 4000 },
    ],
  },
  {
